...
\begin{figure}
    ...
    \includegraphics[width=8cm]{../doc/images/patched_flannel_covid_19_precision_recall_curve.png}
...
\begin{figure}
    \centering
    \includegraphics[width=8cm]{../doc/images/patched_flannel_covid_19_roc_curve.png}
