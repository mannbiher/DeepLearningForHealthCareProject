...
\begin{table*}
    ...
    \begin{tabular}{ |lccccc| } \hline
        ...
        Original FLANNEL          & 0.9239 (0.01) & 0.6675 (0.02)   & 0.8306 (0.01)      &
...
\begin{figure*}
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{../doc/images/ensemble_comparison_precision_recall_curve.png}
        \caption{first figure}
    \end{minipage}
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{../doc/images/ensemble_comparison_roc_curve.png}
...
\begin{figure*}
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{../doc/images/ensemble_covid_19_comparison_precision_recall_curve.png}
        \caption{second figure}
    \end{minipage}
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{../doc/images/ensemble_covid_19_comparison_roc_curve.png}
        \caption{first figure}
    \end{minipage}
\end{figure*}
...
\begin{figure*}
    ...
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{../doc/images/base_flannel_cf.png}
        \caption{second figure}
    \end{minipage}
    \begin{minipage}{0.45\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{../doc/images/patched_flannel_cf.png}
        \caption{first figure}
    \end{minipage}
\end{figure*}
