...
\begin{algorithm}[h]
    ...
    \StageTwo{\;
        \ForE{batch of images from input images and labels}{
            ...
            7. Get mean probability score from all Base Models.\;
...
performance evaluation. It wouldn’t be able to show performance
increase in COVID-19 detection, instead we use F1-score for COVID-19 vs rest
comparing the different models.  As shown in figure \ref{fig:f1score}, we can see the
