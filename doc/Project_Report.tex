...
present Precision-Recall curve for patched FLANNEL. As we see using ROC curve
AUC gives an impression of all models are performing well as they have very less
false positives. However when we look at PR curve, we could see models
performance differ and InceptionV3 and Ensemble model performing better than
others.
