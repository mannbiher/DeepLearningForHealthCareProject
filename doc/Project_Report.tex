...
implementations. Major contribution from authors are
...
\begin{table}
    ...
    \begin{tabular}{|p{0.18\linewidth} | p{0.7\linewidth}|}
        ...
        Author   & Contribution
        \\ \hline
        Maneesh  & AWS Setup, batch run of FLANNEL and patch-based models on
        AWS, patch-based classification development and  ensemble, project
        report, GitHub documentation \\ \hline
        Raman    & segmentation and patch-based classification development,
        output graphs and reports development, project report, GitHub
        documentation report, GitHub documentation
        \\ \hline
        Satish   & FLANNEL checkpoints, output graphs and reports development,
        GitHub documentation
        \\ \hline
        Srikanth & segmentation, patch-based classification development, project
