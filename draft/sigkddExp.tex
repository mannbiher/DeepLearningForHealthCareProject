...
\cite{58871}, a better classification can be achived by training an ensemble of
neural networks on same data instead of individual models and then using a
