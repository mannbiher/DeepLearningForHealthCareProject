...
#    python FLANNEL/ensemble_step1.py --arch resnet152 --epochs=50 -ck_n=10 --cv=cv$i -j=$workers
#    python FLANNEL/ensemble_step1.py --arch resnet152 --epochs=1 -ck_n=10 --cv=cv$i -j=$workers --test
#    python FLANNEL/ensemble_step1.py --arch densenet161 --epochs=1 -ck_n=10 --cv=cv$i -j=$workers
#    python FLANNEL/ensemble_step1.py --arch densenet161 --epochs=1 -ck_n=10 --cv=cv$i -j=$workers --test
#    python FLANNEL/ensemble_step1.py --arch vgg19_bn --epochs=1 -ck_n=10 --cv=cv$i -j=$workers
#    python FLANNEL/ensemble_step1.py --arch vgg19_bn --epochs=1 -ck_n=10 --cv=cv$i -j=$workers --test
