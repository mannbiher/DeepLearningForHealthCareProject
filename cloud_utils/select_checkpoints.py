"""Download checkpoint model from S3

This module allows to download checkpoint model from S3. This allows to resume
the training run from the earlier checkpoint.
"""
